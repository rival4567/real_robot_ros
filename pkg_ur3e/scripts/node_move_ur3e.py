...
def main():
    ...
    ur3e_home_joint_angles = tf.list_degrees_to_radians(
        [90, -90, 0, -90, 0, 90])
    ...
    while not rospy.is_shutdown():
        ...
        # Wait for packages to spawn.s)
        rospy.sleep(1)
        ur3.set_joint_angles(ur3e_home_joint_angles)
        rospy.sleep(1)
        ur3.set_joint_angles([0, 0, 0, 0, 0, 0])
